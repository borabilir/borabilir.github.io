const enTranslations = {
    ...
    career: {
        ...
        description:
            'You can explore my career journey on the timeline below. Click the entries for more details.',
    },
    skills: {
        title: 'Skills',
        description:
            'A showcase of the skills I’ve mastered or used throughout my career.',
    },
    projects: {
        title: 'Recent Projects',
        description:
            'Below, you can find a summary of the most recent projects I have been involved in, accompanied by relevant screenshots.',
        note: '(The project details have not been disclosed due to privacy reasons)',
    },
    letstalk: {
        title: `Let's Talk`,
        subtitle: 'Contact',
